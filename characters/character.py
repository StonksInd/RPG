...
class Character:
    ...
    def dammage_reduction(self, dammage, other) -> int:
        ...
        if crit_esquive >=95:
            print(f"{self.name_perso} esquive l'attaque ennemie")
            return self.hp_basic 
        
        else:
            self.hp_basic -= ((1-(armor/500)) * dammage)
            other.hp_basic -= ((1-(other.armor.armor/500)) * self.armor.thorns)
            print(f"{other.name_perso} a infligé {int(((1-(armor/500)) * dammage))} dégâts à {self.name_perso} ")
    ...
    def magic_dammage_reduction(self, magic_dammage, spell_a_lancer, other) -> int:
        ...
        if crit_esquive >=95:
            ...
            other.mana_basic -= spell_a_lancer.mana_cost
            print(f"{other.name_perso} inflige {int(((1-(magic_resistance/500)) * (magic_dammage *spell_a_lancer.spell_dammage)))} à {self.name_perso}")
        self.hp_basic = int(self.hp_basic)
